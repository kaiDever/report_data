...
class GoogleSheetTest extends TestBase {
    @Autowired
    GoogleSheetRequester googleSheetRequester;
    ...
    public void saveTest() throws IOException {
        ...
        googleSheetRequester.save(dataResponse,"pubmatic");
    }

    @Test
    public void createTest() {
        googleSheetRequester.createSheet("pubmatic");
    }
}